...
public class SpeechSynthesizerTTS {
    ...
    private static final Logger logger = LoggerFactory.getLogger(SpeechSynthesizerTTS.class);
    ...
    public SpeechSynthesizerTTS(String appKey, String accessKeyId, String accessKeySecret, String url) {
        this.appKey = appKey;
        //TODO 重要提示 创建NlsClient实例,应用全局创建一个即可,生命周期可和整个应用保持一致,默认服务地址为阿里云线上服务地址
                ...
                public void onMessage(ByteBuffer message) {
                    try {
                        if(firstRecvBinary) {
                            ...
                            logger.info("tts first latency : " + (now - SpeechSynthesizerTTS.startTime) + " ms");
                        }
...
//            synthesizer.setText("欢迎使用阿里巴巴智能语音合成服务，您可以说北京明天天气怎么样啊");
            ...
            SpeechSynthesizerTTS.startTime = System.currentTimeMillis();
    ...
    public static void main(String[] args) throws Exception {
        String appKey = "m2mbAr79dyzWl70W";
        String id = "LTAIc46qdfSjTCZY";
        String secret = "MGzJxGjpo4tzYHk5O44U5JJEkO2nQS";
        ...
        SpeechSynthesizerTTS demo = new SpeechSynthesizerTTS(appKey, id, secret, url);
        demo.process();
        demo.shutdown();
    }
}
