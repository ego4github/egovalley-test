...
//        String appKey = args[0];
        String appKey = "PyaYTCNZGdPipX2Y";
//        String token = args[1];
        String token = "d1de37eee9544dedab8d0266efee5ad0";
        SpeechTranscriberDemo demo = new SpeechTranscriberDemo(appKey, token);
        InputStream ins = SpeechTranscriberDemo.class.getResourceAsStream("/wechatSR.pcm");
        if (null == ins) {
